...
- **2 Mandatory** issues requiring changes before migration
  - Logging to local or network paths detected
  - Windows authentication detected
- **4 Optional** improvements recommended
  - Static content detected
  - System.Data.SqlClient dependency detected
  - Connection strings without configuration builders detected (2 locations)
- **2 Potential** issues to investigate
  - Connection string detected
  - Session state stored in-proc or in local process detected
